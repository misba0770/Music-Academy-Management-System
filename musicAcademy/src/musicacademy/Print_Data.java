...
import java.sql.*;
   ...
   class Print_Data implements ActionListener {
    ...
    String student_id,name,father,address,phone,email,instrument,level,age,dob,batch;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("musicacademy/icons/print.jpg"));
        id9.setIcon(img);
